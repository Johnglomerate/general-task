...
func TestGetSettingsOptions(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		assert.NoError(t, err)
		assert.Equal(t, 17, len(*settings))
		...
		assert.Equal(t, "has_dismissed_multical_prompt", (*settings)[6].FieldKey)
		assert.Equal(t, insertedSectionID+"_task_sorting_preference_main", (*settings)[7].FieldKey)
		assert.Equal(t, insertedSectionID+"_task_sorting_direction_main", (*settings)[8].FieldKey)
		assert.Equal(t, insertedSectionID+"_task_sorting_preference_overview", (*settings)[9].FieldKey)
		assert.Equal(t, insertedSectionID+"_task_sorting_direction_overview", (*settings)[10].FieldKey)
		assert.Equal(t, "000000000000000000000001_task_sorting_preference_main", (*settings)[11].FieldKey)
		assert.Equal(t, "000000000000000000000001_task_sorting_direction_main", (*settings)[12].FieldKey)
		assert.Equal(t, "000000000000000000000001_task_sorting_preference_overview", (*settings)[13].FieldKey)
		assert.Equal(t, "000000000000000000000001_task_sorting_direction_overview", (*settings)[14].FieldKey)
		calendarSetting := (*settings)[15]
