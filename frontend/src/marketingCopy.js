...
const MARKETING_META_DESCRIPTION = `Plan tasks around Google Calendar with General Task. Start with a ${SUBSCRIPTION_TRIAL_OFFER}.`
const MARKETING_SOCIAL_DESCRIPTION = `Plan tasks around Google Calendar with a ${SUBSCRIPTION_TRIAL_OFFER}.`
